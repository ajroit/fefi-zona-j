#!/usr/bin/env python3
"""
Fetcher de datos Futsal - Reducido Zona A
Consume la API pública de Weball (api.weball.me) y genera data/futsal-reducido-data.json
"""
...
TOURNAMENT_ID = 555        # Reducido - Zona A
...
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "futsal-reducido-data.json")
...
# ── 1. Obtener fases ──────────────────────────────────────
def obtener_fases():
    """Devuelve lista de fases (ej: [{id: 931, name: 'APERTURA', ...}])."""
...
# ── Main ──────────────────────────────────────────────────
def main():
    print("🏟️  Fetcher Futsal - Reducido Zona A")
    print("=" * 50)
